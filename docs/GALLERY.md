...
## 01 / Hero
![Three-quarter studio view](../assets/renders/01_hero.png)

## 02 / Front
![Front studio view](../assets/renders/02_front.png)

## 03 / Side
![Side studio view](../assets/renders/03_side.png)

## 04 / Top
![Top studio view](../assets/renders/04_top.png)

## 05 / Rear
![Rear studio view](../assets/renders/05_rear.png)

## 06 / Camera detail
![Camera aperture and surface detail](../assets/renders/06_detail.png)
The external optical part is a visualization; real optics alignment and mounting remain unverified.

## 07 / Open housing
![Upper cover lifted to expose cavity](../assets/renders/07_open_housing.png)
...
## 08 / Everyday desk
![Digital desk context](../assets/scenes/08_everyday_desk.png)
Synthetic scene with a generic notebook, phone and mug. It does not document device use.

## 09 / Maker workbench
![Digital maker context](../assets/scenes/09_maker_workbench.png)
...
![Photography workbench study](../design/v0.4/presentation/10_workbench_photography.png)
