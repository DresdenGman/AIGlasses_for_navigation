...
## Building local capability in three communities
...
| Context | Hardware-only cost | Basis |
|---|---:|---|
| Earlier prototype made in China | **Under US$20 per unit** | Creator's report of their build at the time |
